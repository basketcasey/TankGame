...
public class CpuTank {
    ...
    public CpuTank(Main main, int xSize, int ySize, int origPosX, int origPosY, Wall wall, Tank tank) {
        this.game = main;
        this.wall = wall;
        enemyTank = tank;
    ...
    public void pursue() {
        ...
        //System.out.println("Angle to enemy tank: " + angle);
        // Get distance to enemy tank
        //Double distance = getDistanceToEnemy(enemyLocation, getTankLocation());

        // determine if walls are in the way
        //System.out.println("Is wall blocking? " + isWallBlockingView(angle));

        // determine if time to shoot
        // determine if time to drive
            // determine angle needed
    }
